      ...
      >
              ...
              {[
                {
                  ...
                  desc: "Your personal building dashboard",
                },
                {
                  title: "Priority Support",
                  desc: "Instant concierge connectivity",
                },
        ...
        <div className="lg:w-7/12 p-10 md:p-14 bg-white/30">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            >
              <div className="flex justify-between items-center ml-1">
                ...
                <Link
                  to="#"
                  className="text-[9px] font-black text-blue-600 hover:text-blue-700 uppercase tracking-widest hover:underline underline-offset-4"
                >
                  Reset Key
                </Link>
              </div>
            ...
            >
              <button
                type="button"
                onClick={() => {
                  setValue("email", "mohdakash307@gmail.com");
                  setValue("password", "123456");
                }}
                className="flex-1 py-3 border border-slate-200 text-slate-500 font-bold text-[10px] uppercase tracking-widest rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all"
              >
                Demo Admin
              </button>
              <button
          ...
          >
            ...
            <span className="flex-shrink mx-4 text-[9px] font-black text-slate-300 uppercase tracking-[0.2em]">
              External Access
            </span>
            <div className="flex-grow border-t border-slate-100"></div>
          </Motion.div>
          ...
          >
            ...
            <Link
              to="/register"
              className="ml-2 text-blue-600 hover:text-blue-700 underline decoration-blue-100 decoration-2 underline-offset-4 transition-colors"
            >
              Apply for Account
            </Link>
          </Motion.p>
